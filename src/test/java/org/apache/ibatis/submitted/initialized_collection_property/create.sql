...
CREATE TABLE POST(POST_ID INTEGER NOT NULL PRIMARY KEY,CONTENT VARCHAR(255) NOT NULL,AUTHOR_ID INTEGER NOT NULL);
CREATE TABLE AUTHOR(AUTHOR_ID INTEGER NOT NULL PRIMARY KEY,NAME VARCHAR(255));
